...
import static be.eddy.bluetoothscanner.R.menu.toolbar;
...
//  Intent intent = new Intent(this, EnterDevice.class);
            ...
            case R.id.about:
                ...
                break;
            case R.id.feedback:
                Toast.makeText(this, "adnansee@gmail.com", Toast.LENGTH_SHORT).show();
            default:
                break;
        }
        return true;
    ...
    private BroadcastReceiver scanModeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (scanMode == BluetoothAdapter.SCAN_MODE_CONNECTABLE
                ...
                Toast.makeText(context, "WELCOME TO BABY SAFE", Toast.LENGTH_SHORT).show();
            }
        }
    };
